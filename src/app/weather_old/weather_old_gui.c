...
#else
const void *image_map[] = {"S:/weather/Sunny_100.bin", "S:/weather/Clear_150.bin", "S:/weather/Clear_150.bin", "S:/weather/Clear_150.bin",
...
void weather_old_gui_init(void)
{
    ...
    lv_style_set_text_font(&label_style1, &ch_font20);
    ...
    lv_style_set_text_font(&label_style2, &lv_font_montserrat_32);
...
void display_weather_old(const char *cityname, const char *temperature, int weathercode, lv_scr_load_anim_t anim_type)
{
    ...
    lv_obj_align(cityname_label, LV_ALIGN_BOTTOM_MID, -30, -30);
